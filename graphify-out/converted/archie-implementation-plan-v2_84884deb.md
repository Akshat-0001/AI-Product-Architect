<!-- converted from archie-implementation-plan-v2.docx -->
...
| CORE PRINCIPLE |
| --- |
| Zero cost to run. Users bring their own Groq or Gemini keys. Archie runs entirely on free tiers for hosting, DB, and auth. Open source MIT. |
